...
class IosMessage extends Base
{
    ...
    {
        $log = new LogRequest('unReadAll', Category::CLIENT_TYPE_IOS);
        ...
        $result = Result::getUnReadAllResult(Category::CLIENT_TYPE_IOS, $syncStamp, $counterArr);
    ...
    {
        $log = new LogRequest('readFromComments', Category::CLIENT_TYPE_IOS);
        $log->request($this->body);
        ...
        $result = Result::getReadFromCommentsResult(Category::CLIENT_TYPE_ANDROID, $syncStamp);
        $this->messageBase($result);
        return true;
    }
    ...
    {
        $log = new LogRequest('readMessage', Category::CLIENT_TYPE_IOS);
        $log->request($this->body);
        ...
        $result = Result::getReadMessageResult(Category::CLIENT_TYPE_IOS, $syncStamp);
        $this->messageBase($result);
        return true;
    }
}
