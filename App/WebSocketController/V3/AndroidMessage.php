...
class AndroidMessage extends Base
{
    ...
    {
        [$toUid, $syncStamp] = Params::autoReplyRobotParams(Category::CLIENT_TYPE_ANDROID, $this->body['to_uid'], $this->body['syncstamp']);
        ...
        $result = Result::getRobotReplyListsResult(Category::CLIENT_TYPE_ANDROID, $data, $syncStamp);
    ...
    {
        [$toUid, $qNumber, $syncStamp] = Params::AutoRobotParams(Category::CLIENT_TYPE_ANDROID, $this->body['to_uid'], $this->body['q_number'], $this->body['syncstamp']);
        ...
        $result = Result::getRobotReplyResult(Category::CLIENT_TYPE_ANDROID, $answer, $syncStamp);
        $this->messageBase($result);
        return true;
    }
    ...
    {
        $this->RobotTimeStampBase(Category::CLIENT_TYPE_ANDROID);
    }
    ...
    {
        [$toUid, $token, $syncStamp] = Params::openCustomerParams(Category::CLIENT_TYPE_ANDROID, $this->body['to_uid'], $this->body['token'], $this->body['syncstamp']);
        ...
        if ($imUserRelation) {
            ...
            $result = Result::getOpenCustomerResult(Category::CLIENT_TYPE_ANDROID, $toUid, $customerName, 200, $syncStamp, $customerHead);
            $this->messageBase($result);
            return true;
        }
        ...
        if (empty($customerLists)) {
            $code = 406;
            $result = Result::getOpenCustomerResult(Category::CLIENT_TYPE_ANDROID, $toUid, '', $code, $syncStamp);
            $this->messageBase($result);
            return true;
        }
        ...
        $result = Result::getOpenCustomerResult(Category::CLIENT_TYPE_ANDROID, $toUid, $customerName, $code, $syncStamp,$customerHead);
        $this->messageBase($result);
        return true;
    }
    ...
    {
        [$toUid, $syncStamp] = Params::closeCustomerParams(Category::CLIENT_TYPE_ANDROID, $this->body['to_uid'], $this->body['syncstamp']);
        ...
        $result = Result::closeCustomerResult(Category::CLIENT_TYPE_ANDROID);
        $this->messageBase($result);
        return true;
    }
    ...
    public function pushCustomer()
    {
        ...
        if (!empty($msgErrorRet)) {
            $result = Result::getPushCustomerResult(Category::CLIENT_TYPE_ANDROID, $msgErrorRet['code'], $syncStamp);
            $this->messageBase($result);
            return true;
        }
        ...
        $data = [
            ...
            'is_sent' => 2,
            'client_type' => Category::CLIENT_TYPE_ANDROID,
        ...
        $result = Result::getPushCustomerResult(Category::CLIENT_TYPE_ANDROID, $code, $syncStamp);
        $this->messageBase($result);
        return true;
    }
     ...
     * 获取是否存在离线消息
     */
    public function pullChatRecord()
    {
        [$toUid, $syncStamp] = Params::pullChatRecordParams(Category::CLIENT_TYPE_ANDROID, $this->body['to_uid'], $this->body['syncstamp']);
        ...
        $result = Result::getPullChatRecordResult(Category::CLIENT_TYPE_ANDROID, $chat, $toUid);
        $this->messageBase($result);
        return true;
    }
    ...
    {
        [$toUid, $syncStamp] = Params::readCustomerParams(Category::CLIENT_TYPE_ANDROID, $this->body['to_uid'], $this->body['syncstamp']);
        ...
        $result = Result::getReadCustomerResult(Category::CLIENT_TYPE_ANDROID);
        $this->messageBase($result);
        return true;
    }
